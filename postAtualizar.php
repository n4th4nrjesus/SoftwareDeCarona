				...
				if ($result = mysqli_query($conn, $sql)) {
					if (mysqli_num_rows($result) > 0) {
						...
						?>				
										...
										<form class="w3-container" action="postAtualizar_exe.php" method="post" onsubmit="return check(this.form)">
											...
											<input type="button" value="Cancelar" class="w3-btn w3-theme" onclick="window.location.href='postListar.php'"></p>
										</form>
